...
import type { Col as ColProps } from "ant-design-vue/types/grid/col";
...
export interface FormItem {
   ...
   */
  extra?: string | VNodeChildren | JSX.Element;
   ...
   * @type any (string | slot)
   */
  help?: string | VNodeChildren | JSX.Element;

  /**
   * Label test
   * @type any (string | slot)
   */
  label?: string | VNodeChildren | JSX.Element;

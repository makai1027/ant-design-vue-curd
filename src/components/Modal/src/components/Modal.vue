...
export default {
  ...
  props: basicProps,
  computed: {
    dragObject(): Recordable {
      const { visible, draggable, destroyOnClose } = this;
      return {
        visible,
        draggable,
        destroyOnClose,
  ...
  methods: {
    ...
    useModalDragMove(context: UseModalDragMoveContext) {

<template>
  <div>
    <Card size="small" title="Ref操作示例" class="!mb-4">
      <div class="mb-4">
      ...
      <div class="mb-4">
        ...
        <a-button
          @click="setProps({ showActionButtonGroup: true })"
          class="mr-2"
        >
          显示操作按钮
        </a-button>
    ...
    <Card size="small" title="使用ref调用表单内部函数示例">
      <BasicForm
        :schemas="schemas"
        ref="formElRef"
        :labelWidth="100"
...
export default defineComponent({
  components: { BasicForm, Card, [Button.name]: Button },
  setup() {
